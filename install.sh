...
echo -e "#   Homepage: http://pysmssend.sourceforge.net         #"
echo -e "#   Bug Reports :  hwoarang_gr@users.sourceforge.net   #"
echo -e "#   Please note that Yahoo SMS Service is in beta mode #"
echo -e "#   and needs a lot of feedback			#"
echo    "########################################################"
