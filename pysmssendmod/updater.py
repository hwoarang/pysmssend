...
class Ui_Updater(object):
    ...
    def retranslateUi(self, Updater):
        ...
        "<p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Go to http://pysmssend.sourceforge.net to download the new version</p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
