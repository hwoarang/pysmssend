...
class Ui_Sent(object):
    ...
    def retranslateUi(self, Sent,lines):
        Sent.setWindowTitle(QtGui.QApplication.translate("Sent", "Pysmssend 1.48", None, QtGui.QApplication.UnicodeUTF8))
        Sent.setStatusTip(QtGui.QApplication.translate("Sent", "Pysmssend 1.48", None, QtGui.QApplication.UnicodeUTF8))
